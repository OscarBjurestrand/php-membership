...
This system is not very pretty and has only the required styling in order to show you all the different functions. I created it this way so you don't have to delete any styling and can start building on it right away.
